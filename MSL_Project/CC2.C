...
void CC2_vInit(void)
{
  ...
  ///  - the CC2 module clock = 65,00 MHz
  ...
  //// - the contents of the port register is not changed by the CAPCOM2 
  ////   unit. Use the macro CC2_vPortUnlock() for unlock the port.

  CC2_IOC        =  0x0002;      // load CAPCOM2 I/O control register
  ...
  CC2_T7         =  0xF9A7;      // load CAPCOM2 timer 7 register

  CC2_T7REL      =  0xF9A7;      // load CAPCOM2 timer 7 reload register
