...
void CCU63_vInit(void)
{
  ...
  CCU63_CC60SR   =  0x07F0;      // Load CCU63 capture/compare shadow 
  ...
  ///  - The compare output CC61 drives passive level while CC61ST is '1'
  ...
  CCU63_CC61SR   =  0x07F0;      // Load CCU63 capture/compare shadow 
  ...
  CCU63_CC62SR   =  0x07F0;      // Load CCU63 capture/compare shadow 
  ...
  CCU63_T12DTC   =  0x0162;      // load CCU63 dead time control register for 
                                 // timer T12

  CCU63_T12MSEL  =  0x0011;      // load CCU63 T12 campture/compare mode 
                                 // select register

  CCU63_CMPSTAT  =  0x0600;      // load CCU63 compare status register

  CCU63_MODCTR   =  0x000D;      // load CCU63 modulation control register
  ...
  ///  - Timer 12 run bit is set
  ///  - Timer 13 run bit is reset
  CCU63_TCTR4    =  0x4042;      // load CCU63 timer control register 4
